...
void main()
{
    ...
    vec2 pixel_tl = invscale * (pixel - vec2(0.5, 0.5));   // input pixel-coordinates of the output pixel's top-left corner
    vec2 pixel_br = invscale * (pixel + vec2(0.5, 0.5));    // input pixel-coordinates of the output pixel's bottom-right corner
